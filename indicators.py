...
def drop_corr_features(df, threshold, plot):
    df_copy = df.copy()
...
def get_trend_indicators(df, threshold=0.5, plot=False):
    ...
    return drop_corr_features(df_trend, threshold, plot)
...
def get_volatility_indicators(df, threshold=0.5, plot=False):
    ...
    return drop_corr_features(df_volatility, threshold, plot)
...
def get_volume_indicators(df, threshold=0.5, plot=False):
    ...
    return drop_corr_features(df_volume, threshold, plot)
...
def get_momentum_indicators(df, threshold=0.5, plot=False):
    ...
    return drop_corr_features(df_momentum, threshold, plot)
...
def get_others_indicators(df, threshold=0.5, plot=False):
    ...
    return drop_corr_features(df_others, threshold, plot)
...
def get_all_indicators(df, threshold=0.5, plot=False):
    ...
    return drop_corr_features(df_all, threshold, plot)
